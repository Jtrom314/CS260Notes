...
Since there weren't any follow up messages placing restrictions on what could be contained in our README.md file, although accessing links placed on the README file were forbidden, I have taken the liberty to take full advantage of the opportunity at hand by placing what I found to be the most useful information (which is pratically everything!) in this extremely long document. Enjoy :)

Also, Professor Jensen, a few class periods ago you mentioned that you hope I was getting my money's worth out of this course. I have to say, yes I am. Perhaps more so than most of the other classes I have taken so far in my BYU carrer. Thank you. 
...
* Pull the repository's lastest changes from GitHub (`git pull`)
